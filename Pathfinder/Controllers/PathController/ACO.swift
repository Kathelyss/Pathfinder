...
class ACO {
    ...
    init(beta: Double) {
        ...
        routes =
            [[Route(distance: 0, pheromone: 0), Route(distance: AB, pheromone: ABpheromone),
              Route(distance: AC, pheromone: ACpheromone), Route(distance: AD, pheromone: ADpheromone)],

             [Route(distance: AB, pheromone: BApheromone), Route(distance: 0, pheromone: 0),
              Route(distance: BC, pheromone: BCpheromone), Route(distance: BD, pheromone: BDpheromone)],

             [Route(distance: AC, pheromone: CApheromone), Route(distance: BC, pheromone: CBpheromone),
              Route(distance: 0, pheromone: 0), Route(distance: CD, pheromone: CDpheromone)],

             [Route(distance: AD, pheromone: DApheromone), Route(distance: BD, pheromone: DBpheromone),
              Route(distance: CD, pheromone: DCpheromone),Route(distance: 0, pheromone: 0)]]
    ...
    func finishDialog(_ message: String) {
        ...
        alert.title = "Traveling completed"
        alert.message = message
//        alert.actions.append(UIAlertAction(title: "Ok", style: .cancel, handler: nil))
//        alert.runModal()
    }
